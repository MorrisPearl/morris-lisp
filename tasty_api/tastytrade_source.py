...
PRODUCTS = {
    "ES": {"root":"/ES","opt": 1, "label": "E-mini S&P 500 *"},
    "MES": {"root":"/MES","opt": 1, "label": "Micro E-mini S&P 500 *"},
    "NQ": {"root":"/NQ","opt": 1, "label": "E-mini Nasdaq 100 *"},
    "MNQ": {"root":"/MNQ","opt": 1, "label": "Micro E-mini NASDAQ 100 *"},
    "YM": {"root":"/YM","opt": 0, "label": "E-mini Dow 30"},
    "MYM": {"root":"/MYM","opt": 0, "label": "Micro E-mini DOW"},
    "RTY": {"root":"/RTY","opt": 1, "label": "E-mini Russell 2000 *"},
    "M2K": {"root":"/M2K","opt": 0, "label": "Micro E-mini Russell 2000"},
    "ZT": {"root":"/ZT","opt": 1, "label": "2 Year T-Note *"},
    "ZF": {"root":"/ZF","opt": 1, "label": "5 Year T-Note *"},
    "ZN": {"root":"/ZN","opt": 1, "label": "10 Year T-Note *"},
    "ZB": {"root":"/ZB","opt": 1, "label": "30 Year T-Bond *"},
    "SR3": {"root":"/SR3","opt": 1, "label": "Three-Month SOFR *"},
    "2YY": {"root":"/2YY","opt": 0, "label": "2-Year Yield"},
    "5YY": {"root":"/5YY","opt": 0, "label": "5-Year Yield"},
    "10Y": {"root":"/10Y","opt": 0, "label": "10-Year Yield"},
    "30Y": {"root":"/30Y","opt": 0, "label": "30-Year Yield"},
    "TN": {"root":"/TN","opt": 0, "label": "Ultra 10-Year U.S. Treasury Note"},
    "UB": {"root":"/UB","opt": 0, "label": "Ultra U.S. Treasury Bonds"},
    "6E": {"root":"/6E","opt": 1, "label": "Euro FX *"},
    "M6E": {"root":"/M6E","opt": 0, "label": "Micro Euro"},
    "6J": {"root":"/6J","opt": 1, "label": "Japanese Yen *"},
    "6B": {"root":"/6B","opt": 1, "label": "British Pound *"},
    "M6B": {"root":"/M6B","opt": 0, "label": "Micro British Pound"},
    "6C": {"root":"/6C","opt": 1, "label": "Canadian Dollar *"},
    "MCD": {"root":"/MCD","opt": 0, "label": "Micro Canadian Dollar"},
    "6A": {"root":"/6A","opt": 1, "label": "Australian Dollar *"},
    "M6A": {"root":"/M6A","opt": 0, "label": "Micro Australian Dollar"},
    "6M": {"root":"/6M","opt": 0, "label": "Mexican Peso"},
    "6S": {"root":"/6S","opt": 0, "label": "Swiss Franc"},
    "CL": {"root":"/CL","opt": 1, "label": "Crude Oil *"},
    "MCL": {"root":"/MCL","opt": 1, "label": "Micro Crude Oil *"},
    "QM": {"root":"/QM","opt": 0, "label": "E-mini Crude Oil"},
    "NG": {"root":"/NG","opt": 1, "label": "Henry Hub Natural Gas *"},
    "MNG": {"root":"/MNG","opt": 0, "label": "Micro Henry Hub Natural Gas"},
    "QG": {"root":"/QG","opt": 0, "label": "E-mini Natural Gas"},
    "RB": {"root":"/RB","opt": 0, "label": "RBOB Gasoline"},
    "HO": {"root":"/HO","opt": 0, "label": "Heating Oil"},
    "BZ": {"root":"/BZ","opt": 0, "label": "Brent Crude Oil"},
    "GC": {"root":"/GC","opt": 1, "label": "Gold *"},
    "MGC": {"root":"/MGC","opt": 0, "label": "Micro Gold"},
    "1OZ": {"root":"/1OZ","opt": 0, "label": "1-oz. Gold"},
    "HG": {"root":"/HG","opt": 1, "label": "Copper *"},
    "MHG": {"root":"/MHG","opt": 0, "label": "Micro Copper"},
    "SI": {"root":"/SI","opt": 1, "label": "Silver *"},
    "SIL": {"root":"/SIL","opt": 0, "label": "Micro Silver"},
    "SIC": {"root":"/SIC","opt": 0, "label": "Silver 100-oz."},
    "PL": {"root":"/PL","opt": 0, "label": "Platinum"},
    "PA": {"root":"/PA","opt": 0, "label": "Palladium"},
    "ZC": {"root":"/ZC","opt": 1, "label": "Corn Futures *"},
    "XC": {"root":"/XC","opt": 0, "label": "Mini Corn"},
    "ZS": {"root":"/ZS","opt": 1, "label": "Soybean *"},
    "XK": {"root":"/XK","opt": 0, "label": "Mini Soybean"},
    "ZW": {"root":"/ZW","opt": 1, "label": "Chicago SRW Wheat *"},
    "XW": {"root":"/XW","opt": 0, "label": "Mini Chicago SRW Wheat"},
    "BTC": {"root":"/BTC","opt": 1, "label": "Bitcoin *"},
    "MBT": {"root":"/MBT","opt": 0, "label": "Micro Bitcoin"},
    "ETH": {"root":"/ETH","opt": 1, "label": "Ether *"},
    "MET": {"root":"/MET","opt": 0, "label": "Micro Ether"},
    "MXP": {"root":"/MXP","opt": 0, "label": "Micro XRP"},
    "LE": {"root":"/LE","opt": 1, "label": "Live Cattle *"},
    "HE": {"root":"/HE","opt": 1, "label": "Lean Hog *"},
    "VX": {"root":"/VX","opt": 0, "label": "CBOE Volatility Index"},
    "VXM": {"root":"/VXM","opt": 0, "label": "CBOE Mini Volatility Index"}
}
